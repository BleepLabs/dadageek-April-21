...
AudioSynthWaveform       waveform1;      //xy=269.00001525878906,462.00001335144043
AudioSynthWaveform       waveform2;      //xy=286,525
AudioEffectEnvelope      envelope2;      //xy=446,502
AudioEffectEnvelope      envelope1;      //xy=450,398
AudioMixer4              mixer1;         //xy=601,467.0000915527344
AudioOutputI2S           i2s1;           //xy=742,547
...
AudioControlSGTL5000     sgtl5000_1;     //xy=633,323
